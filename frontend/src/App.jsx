    ...
    return (
        <div className='min-h-screen bg-gray-800 p-4'>
            <div className='max-w-4xl mx-auto text-center mb-8'>
                <h1 className='text-yellow-300 sm:text-3xl font-bold underline text-xl'>
                    The News Classifier
                </h1>
                <p className='text-gray-400 text-sm mt-2'>
                    Classify news articles with customizable preprocessing and vectorization techniques.
                </p>
            </div>
            <div className='max-w-4xl mx-auto flex flex-wrap sm:space-x-4 space-x-1 sm:mb-4 mb-2 text-white' aria-label='Breadcrumb'>
                {tabs.map((tab, index) => (
                    <div key={tab} className='flex items-center sm:space-x-2 space-x-1'>
                        <span
                            className={`py-1 sm:text-lg text-sm ${index <= currentIndex
